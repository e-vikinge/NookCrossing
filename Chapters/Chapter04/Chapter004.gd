...
onready var dialogue_path = "Ch04_Stage01_Dialog01_Tortimer.json"
...
func _ready() -> void:
	...
	if Global.masterMusicPlayingCH == 4:
		pass
	if Global.masterMusicPlayingCH != 4:
		Global.current_song("MusicGameCube4PM")
#
#	if Global.sceneTransitionCH == 4:
#		pass
	if Global.sceneTransitionCH == 4:
		get_node("Intro/SceneTransition/AnimationPlayer").play("FadeInLong")
		Global.chapterIntroText("CanvasLayer/ChapterFour")
		Global.sceneTransitionCH = 5
...
#	if Global.chapterIntroTextCH == 4:
#		Global.chapterIntroText("CanvasLayer/ChapterFour")
#	else:
		pass
