...
onready var dialogue_path = "Ch07_Stage01_Dialog01_Tortimer.json"
...
#	if Global.sceneTransitionCH == 7:
#		Global.playeroutside_pos = Vector2(1010, 175)
	
	Global.current_mail = mail_path
	Global.current_dialog = dialogue_path
	if Global.masterMusicPlayingCH == 7:
		pass
	if Global.masterMusicPlayingCH != 7:
		Global.current_song("MusicGameCube6AM")
#
#	if Global.sceneTransitionCH == 4:
#		pass
	if Global.sceneTransitionCH == 7:
		get_node("Intro/SceneTransition/AnimationPlayer").play("FadeInLong")
		Global.chapterIntroText("CanvasLayer/ChapterSeven")
		Global.sceneTransitionCH = 8
...
#	if Global.chapterIntroTextCH == 7:
#		Global.chapterIntroText("CanvasLayer/ChapterSeven")
#	else:
		pass
