...
onready var dialogue_path = "Ch011_Stage01_Dialog01_Tortimer.json"
...
func _ready() -> void:
	...
	if Global.masterMusicPlayingCH == 11:
		pass
	if Global.masterMusicPlayingCH != 11:
		Global.current_song("MusicGameCube8AM")
#
#	if Global.sceneTransitionCH == 4:
#		pass
	if Global.sceneTransitionCH == 11:
		get_node("Intro/SceneTransition/AnimationPlayer").play("FadeInLong")
		Global.chapterIntroText("CanvasLayer/ChapterEleven")
		Global.sceneTransitionCH = 12
...
#	if Global.chapterIntroTextCH == 11:
#		Global.chapterIntroText("CanvasLayer/ChapterEleven")
#	else:
		pass
