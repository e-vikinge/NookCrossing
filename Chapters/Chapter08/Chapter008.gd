...
onready var dialogue_path = "Ch08_Stage01_Dialog01_Tortimer.json"
...
func _ready() -> void:
	...
	if Global.masterMusicPlayingCH == 8:
		pass
	if Global.masterMusicPlayingCH != 8:
		Global.current_song("MusicGameCube6PM")
#
#	if Global.sceneTransitionCH == 4:
#		pass
	if Global.sceneTransitionCH == 8:
		get_node("Intro/SceneTransition/AnimationPlayer").play("FadeInLong")
		Global.chapterIntroText("CanvasLayer/ChapterEight")
		Global.sceneTransitionCH = 9
...
#	if Global.chapterIntroTextCH == 8:
#		Global.chapterIntroText("CanvasLayer/ChapterEight")
#	else:
		pass
