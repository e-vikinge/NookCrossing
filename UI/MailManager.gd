...
#---File---#
var file_name = Global.current_mail# You could pass a new file here on area body enter or whenever you feel like
...
#------UI--------#
onready var dialogueText = $MailText 
onready var dialoguePanel = self #Less rewritting if you want to move the script to another object
onready var dialogueName = $Text2
onready var dialogueButtons = [$Control/ExitButton, $Control/ExitButton2] 
